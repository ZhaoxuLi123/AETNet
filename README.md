...
## News & Updates
* **May 20, 2025:** We have fixed the bug in ANTNet that it could only handle hyperspectral images of fixed sizes. **Now, the pre-trained models we provide can process images of any band and any size.** We have demonstrated this with the Sandiego dataset and ABU dataset in detect_any_HSI.py.
